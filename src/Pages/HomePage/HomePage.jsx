    ...
    return (
        <div className="homePage">
            ...
            <div className="introParagraph1">
                ...
                <p className="introParagraph3">Conectamos dueños de mascotas con <br /> veterinarios expertos en emergencias para <br /> brindarte tranquilidad cuando más la necesitas.</p>
            ...
            <Row className="pug-row">
                <Col md='6' className="dogQuestions">
                    ...
                    <div>
                        ...
                        <Link to="questions#perros" className="button-faqs">Saber más</Link>
                    </div>
                </Col>
            ...
            <Row className="cat-row">
                ...
                <Col md='6' className="catQquestions">
                    ...
                    <div>
                        ...
                        <Link to="/questions#gatos" className="button-faqs">Saber más</Link>
                    </div>
                </Col>
            </Row>
            ...
            <Row className="exotic-row">
                <Col md='6' className="exoticQuestions">
                    ...
                    <div>
                        ...
                        <Link to="/questions#exoticos" className="button-faqs">Saber más</Link>
                    </div>
                </Col>
                <Col md='6' className="img-col-center">
                    <div className="img-wrapper">
                    ...
                    <Card className="plans-card">
                        <Card.Title className="cardTitle">
                            ...
                            <div>
                                ...
                                <p className="plansCategories">El seguro para los mas peques</p>
                            </div>
                        </Card.Title>
                        <hr />
                    ...
                    <Card className="plans-card">
                        <Card.Title className="cardTitle">
                            ...
                            <div>
                                ...
                                <p className="plansCategories">El seguro para los adultos</p>
                            </div>
                        </Card.Title>
                        <hr />
                        <Card.Body className="cardBody">
                    ...
                    <Card className="plans-card">
                        <Card.Title className="cardTitle">
                            ...
                            <div>
                                ...
                                <p className="plansCategories">El seguro para los abueletes</p>
                            </div>
                        </Card.Title>
                        <hr />
                        <Card.Body className="cardBody">
