...
const EuthanasiaPage = () => {
    ...
    return (
        <div className="EuthanasiaPage">
            ...
            <p> Nuestro equipo está compuesto por profesionales dedicados y comprensivos, que están aquí para brindarte apoyo en cada paso del proceso. <br />Desde la primera llamada hasta el último adiós, nos comprometemos a proporcionarte el respeto, la compasión y la atención que tanto tú como tu mascota merecen.</p>

            <p> Entendemos que esta decisión no es fácil, y queremos que sepas que estás tomando la mejor opción para aliviar el sufrimiento de tu amigo peludo. <br /> Estamos aquí para responder a tus preguntas, escuchar tus preocupaciones y brindarte el consuelo que necesitas en este momento tan difícil.</p>
            ...
            <p>Además, si sientes que necesitas más apoyo emocional durante este proceso de despedida, te recomendamos visitar la página web de nuestrxs compañerxs, <br /> Lara Aguerre y Fran Pazos, quienes han creado MENTALIA. </p>
            <p> MENTALIA es una red que conecta psicólogos con pacientes de manera online, brindando un espacio seguro y confidencial para explorar tus emociones <br /> y recibir el apoyo necesario durante este momento tan delicado. Puedes encontrar más información en su página web:</p>
            <Link to={"#"}>👉🏽********enlace a MENTALIA.*********</Link>
            <br />
