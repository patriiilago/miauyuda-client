            ...
            <Container>
                ...
                <Row className="faqsRow">
                    <Col className="faqsCol" md='6'>
                        ...
                        <Accordion >
                            <Accordion.Item eventKey="0">
                                <Accordion.Header>Quiero hacer una dieta para mi Perro/Gato. ¿Qué debo tener en cuenta?</Accordion.Header>
                                <Accordion.Body>
                    ...
                    <Col className="faqsCol" md='6'>
                        ...
                        <Accordion >
                            <Accordion.Item eventKey="0">
                                <Accordion.Header>¿Cada cuanto tiempo es recomendable bañar a mi perro?</Accordion.Header>
                                <Accordion.Body>
                        ...
                        <Accordion >
                            <Accordion.Item eventKey="0">
                                <Accordion.Header>¿Qué señales indican que mi peludo no está bien?</Accordion.Header>
                                <Accordion.Body>
                ...
                <Row className="faqsRow">
                    <Col className="faqsCol" md='6'>
                        ...
                        <Accordion >
                            <Accordion.Item eventKey="0">
                                <Accordion.Header>¿Necesita mi Gato una limpieza de boca?</Accordion.Header>
                                <Accordion.Body>
                                    La enfermedad periodontal, es uno de los procesos más comunes en perros y gatos adultos. El mal aliento, es uno de los primeros signos de que puede estar padeciendo enfermedad dental.
                    ...
                    <Col className="faqsCol" md='6'>
                        ...
                        <Accordion >
                            <Accordion.Item eventKey="0">
                                <Accordion.Header>¿Qué puedo hacer para que mi gato no engorde?</Accordion.Header>
                                <Accordion.Body>
                ...
                <Row className="faqsRow">
                    <Col className="faqsCol" md='6'>
                        <Accordion >
                            <Accordion.Item eventKey="0">
                                <Accordion.Header>¿Cómo saber si mi pájaro está enfermo?</Accordion.Header>
                                <Accordion.Body>
                        ...
                        <Accordion >
                            <Accordion.Item eventKey="0">
                                <Accordion.Header>¿Por qué mi pez nada de lado?</Accordion.Header>
                                <Accordion.Body>
                        ...
                        <Accordion >
                            <Accordion.Item eventKey="0">
                                <Accordion.Header>¿Está bien dar a mi tortuga comida para gatos o perros?</Accordion.Header>
                                <Accordion.Body>
                    ...
                    <Col className="faqsCol" md='6'>
                        <Accordion >
                            <Accordion.Item eventKey="0">
                                ...
                                <Accordion.Body>
                                    <ul>
                                        <li><strong>Diamante mandarín:</strong> Este lorito apenas supera los 12 centímetros. Su pico y sus patas son rojos y sus plumas claras. Son una de las aves exóticas más conocidas.</li>
                                        <li><strong>Cacatúa:</strong> Cualquiera de sus tipos está permitido. Las puedes encontrar de numerosos colores y pueden vivir hasta 30 años. Además, son muy inteligentes y puedes enseñarles hablar.</li>
                                        <li><strong>Agapornis:</strong> Uno de los loritos más conocidos. Es mucho mejor que vivan en pareja y son fácilmente domesticables. Su brillante colorido es no de sus grandes atractivos.</li>
                                        <li><strong>Periquitos:</strong> De las más comunes en los hogares. Su canto no deja indiferente a nadie, sin duda te alegrará el día.</li>
                                        <li><strong>Loros:</strong> El pájaro exótico más conocido de todos y uno de los más habituales para tener como mascota. Es el animal exótico que se puede tener como mascota más longeva, hasta 80 años.</li>
                                    </ul>
                                </Accordion.Body>
                            </Accordion.Item>
                        </Accordion>
                        <Accordion >
                            <Accordion.Item eventKey="0">
                                <Accordion.Header>¿Qué debo alimentar a mi tortuga?</Accordion.Header>
                                <Accordion.Body>
                        ...
                        <Accordion >
                            <Accordion.Item eventKey="0">
                                <Accordion.Header>¿Qué acuario necesita un goldfish para vivir?</Accordion.Header>
                                <Accordion.Body>
                        ...
                        <Accordion >
                            <Accordion.Item eventKey="0">
                                <Accordion.Header>¿Qué puedo hacer con un pájaro herido?</Accordion.Header>
                                <Accordion.Body>
